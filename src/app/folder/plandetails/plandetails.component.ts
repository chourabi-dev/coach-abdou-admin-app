...
export class PlandetailsComponent implements OnInit {
  ...
  ionViewWillEnter(){
    ...
    //this.workoutjson = this.workoutplan.json_boc;


    this.getGymInfo();
    this.getExercicesList();

    this.jsonVersionWorkout = this.workoutplan.json_boc;
  ...
  doneMakingProgram(){
    ...
    this.gym.updateWorkoutData(this.workoutplan.id_workout, JSON.stringify(plan)).subscribe((res)=>{
